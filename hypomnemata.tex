...
% ``Towards a general model of associated relations,'' https://folk.uio.no/stevepe/Pepper&Arnaud2020.pdf
...
(``cottage cheese, spaghetti western, godfather'') or metaphorical
(``milk tooth'' and the ``-father'' element in ``godfather'').
