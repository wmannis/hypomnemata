...
distinction): \I{1ex, 1in, 2, 3; 1sg, 1pl, 2 3; 1sg, 2/3sg.m. 2/3sg.f,
  1pl, 2/3pl.m, 2/3pl.f}.  The system \I{1, 2, 3}, with no number
distinction, occurs a few places.  Some of these systems distinguish
``I'' from ``not-I'' only.  However, 1/2, 3 systems also occur.  Quite
rich pronoun systems might still lack a separate 3rd person form
(using, say, a demonstrative).  Independent, citation forms might be
lacking altogether, with nominalized inflected forms of ``be'' used
instead (\I{part-1}-be-\I{nmlz}).
